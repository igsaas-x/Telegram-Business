...
class TestACLEDABankParser(unittest.TestCase):
    ...
    def test_acleda_khmer_usd(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message, "ACLEDABankBot")
...
class TestABABankParser(unittest.TestCase):
    ...
    def test_aba_english_khr(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"PayWayByABA_bot")
        self.assertEqual(currency, '៛')
...
class TestPLBBankParser(unittest.TestCase):
    ...
    def test_plb_khr(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"PLBITBot")
        self.assertEqual(currency, '៛')
...
class TestCanadiaBankParser(unittest.TestCase):
    ...
    def test_canadia_usd(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"CanadiaMerchant_bot")
        self.assertEqual(currency, '$')
...
Hash: 8babcc36"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"vattanac_bank_merchant_prod_bot")
        self.assertEqual(currency, '$')
...
class TestCPBankParser(unittest.TestCase):
    ...
    def test_cpbank_khr_received(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"CPBankBot")
        self.assertEqual(currency, '៛')
...
class TestSathabanaBankParser(unittest.TestCase):
    ...
    def test_sathapana_usd(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"SathapanaBank_bot")
        self.assertEqual(currency, '$')
...
class TestChipMongBankParser(unittest.TestCase):
    ...
    def test_chipmong_khr(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"chipmongbankpaymentbot")
        self.assertEqual(currency, '៛')
...
- Transaction Date: 11-Oct-25 09:43.44 AM"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"prasac_merchant_payment_bot")
        self.assertEqual(currency, '$')
...
**KHR 10,000** is paid from **THAK, CHHORN** to **RANN, DANIEL** on **15-09-2025 04:17 PM** with Transaction ID: **17579278527470001**"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"AMKPlc_bot")
        self.assertEqual(currency, '៛')
...
Hash: ab32be50"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"prince_pay_bot")
        self.assertEqual(currency, '$')
...
អ្នកលក់: smlshopcashier"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"s7pos_bot")
        self.assertEqual(currency, '$')
        self.assertEqual(amount, 10.00)
        self.assertIsNotNone(trx_time)
        self.assertEqual(trx_time.year, 2025)
...
-Name    : Soeun Theara & Theng ra yuth"""
        currency, amount, trx_time = extract_amount_currency_and_time(message,"S7days777")
        self.assertEqual(currency, '$')
...
class TestPaymentBKParser(unittest.TestCase):
    ...
    def test_payment_bk_fallback(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"payment_bk_bot")
        self.assertEqual(currency, '$')
        self.assertEqual(amount, 10.00)
...
class TestUnknownBotFallback(unittest.TestCase):
    ...
    def test_unknown_bot_universal_parser(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"unknown_bot_123")
        self.assertEqual(currency, '$')
    ...
    def test_unknown_bot_khmer_pattern(self):
        ...
        currency, amount, trx_time = extract_amount_currency_and_time(message,"unknown_bot_xyz")
        self.assertEqual(currency, '៛')
