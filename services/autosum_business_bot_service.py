...
from handlers.business_support_static_message import BusinessSupportStaticMessage
from models import ChatService, UserService
from events import MockCallBackEvent
...
class AutosumBusinessBot(BusinessSupportStaticMessage):
    """
    ...
    def setup(self):
        ...
        self.app.add_handler(
            CallbackQueryHandler(self.handle_close_menu, pattern="^close_menu$")
        )
