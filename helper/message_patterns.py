...
# Extract last 3 digits of account: "(*708)", "(*332)"
PAID_BY_PATTERN = re.compile(r'\(\*(\d{3})\)')

# Extract payer name from messages like:
...
# "paid by CHANG CHUN-WEI (*889)" -> "CHANG CHUN-WEI" (name with hyphen)
