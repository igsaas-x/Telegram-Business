...
async def custom_business_monthly_report(chat_id: int, start_date: datetime, end_date: datetime, group_name: str = None) -> str:
    """Generate custom monthly report with Shift 1 and Shift 2 columns (only 2 shifts allowed)"""
